 ...
 * 创建微信小程序组件
 */
class CreateDouyinMiniProgramComponentAction :
        CreateDouyinMiniProgramFileGroupAction<CreateDouyinMiniProgramComponentAction.Dialog>() {

    companion object {
        const val NAME = "Douyin Mini Program Component"
        const val JSON_TEMPLATE_NAME = "Douyin mini program component json file"
        const val JS_TEMPLATE_NAME = "Douyin mini program component js file"
    }
    ...
    override fun getJsComponentTemplateName(): String {
        return "Douyin mini program component js file"
    }

    override fun getJsonComponentTemplate(): String {
        return "Douyin mini program component json file"
    }
