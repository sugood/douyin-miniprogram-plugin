 ...
 * 可选是否使用Component API
 */
class CreateDouyinMiniProgramPageAction :
        CreateDouyinMiniProgramFileGroupAction<CreateDouyinMiniProgramPageAction.Dialog>() {
    ...
    override fun getJsComponentTemplateName(): String {
        return "Douyin mini program page js file($apiName API)"
    }

    override fun getJsonComponentTemplate(): String {
        return "Douyin mini program page json file($apiName API)"
    }
    ...
    companion object {
        const val NAME = "Douyin Mini Program Page"
    }
