...
package com.sugood.ijplugin.tt_miniprogram.context
...
abstract class RelateFileHolder {
    ...
    companion object {
        val MARKUP = QQCompatibleRelateFileHolder(QMLFileType.INSTANCE, TTMLFileType.INSTANCE)
        val SCRIPT = SingleFileTypeFileHolder(JavaScriptFileType.INSTANCE)
        val STYLE = QQCompatibleRelateFileHolder(QSSFileType.INSTANCE, TTSSFileType.INSTANCE)
