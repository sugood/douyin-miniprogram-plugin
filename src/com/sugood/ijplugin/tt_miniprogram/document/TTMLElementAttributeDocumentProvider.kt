...
package com.sugood.ijplugin.tt_miniprogram.document
...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils.WXMLElementFactory
import com.sugood.ijplugin.tt_miniprogram.reference.MarkupTwoWayBindingReference
import com.sugood.ijplugin.tt_miniprogram.utils.findStringPropertyValue

/**
 * 对wxml自带的组件的属性提供文档
 */
class TTMLElementAttributeDocumentProvider : DocumentationProvider {
    ...
    override fun generateDoc(element: PsiElement, originalElement: PsiElement?): String? {
        if (element is JsonStringLiteral && element.containingFile.name == "elementDescriptions.json") {
            ...
            TTMLMetadata.getElementDescriptions(element.project).find {
                it.name == elementName
    ...
    override fun getDocumentationElementForLink(
        ...
        if (element is JsonStringLiteral && element.containingFile.name == "elementDescriptions.json") {
            ...
            val definedElement = TTMLMetadata.getElementDescriptions(element.project).find {
                it.name == elementName
