...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.WXMLElementDescription
 ...
 * 对WXML的自带组件提供文档
 */
class TTMLElementDocumentProvider : DocumentationProvider {
    ...
    override fun generateDoc(element: PsiElement, originalElement: PsiElement?): String? {
        if (isInsideJsonConfigFile(element) && element is JsonStringLiteral) {
            if (element.parent?.parent?.parent == element.containingFile) {
                ...
                val wxmlElementDescriptor = TTMLMetadata.getElementDescriptions(element.project).find {
                    it.name == name
                }
