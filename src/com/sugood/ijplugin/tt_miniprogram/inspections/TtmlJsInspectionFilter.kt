...
import com.sugood.ijplugin.tt_miniprogram.utils.getParentOfType

class TtmlJsInspectionFilter : IntentionAndInspectionFilter(), InspectionSuppressor {
    ...
    override fun isSuppressedFor(element: PsiElement, toolId: String): Boolean {
        return element.getParentOfType<JSEmbeddedContent>()?.parent?.language == TTMLLanguage.INSTANCE && suppressedToolIds.contains(
                toolId
        )
    }
}