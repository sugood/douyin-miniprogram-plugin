...
import com.sugood.ijplugin.tt_miniprogram.context.MyJSPredefinedLibraryProvider
...
import com.sugood.ijplugin.tt_miniprogram.utils.JavaScriptElementFactory
import com.sugood.ijplugin.tt_miniprogram.utils.addProperty

/**
 * 在组件对应的js文件中创建事件处理函数
 */
class TTMLCreateEventHandlerIntentionAction : IntentionAction, PsiElementBaseIntentionAction() {
