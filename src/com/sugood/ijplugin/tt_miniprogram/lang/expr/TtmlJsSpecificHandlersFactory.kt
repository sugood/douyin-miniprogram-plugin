...
package com.sugood.ijplugin.tt_miniprogram.lang.expr
...
import com.sugood.ijplugin.tt_miniprogram.context.MyJSPredefinedLibraryProvider.Companion.PAGE_LIFETIMES
import com.sugood.ijplugin.tt_miniprogram.context.RelateFileHolder
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.TtmlJSInjector
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils.isEventHandler

class TtmlJsSpecificHandlersFactory : JavaScriptSpecificHandlersFactory() {
    ...
    override fun createReferenceExpressionResolver(
        ...
        return TtmlJsReferenceExpressionResolver(referenceExpression, ignorePerformanceLimits)
    }

}

/**
 * 控制ttml 中的表达式如何引用 js 中的标识符
 */
class TtmlJsReferenceExpressionResolver(
        ...
        if (myQualifier == null) {
            ...
            if (jsPsiFile != null) {
                if (injectionHost is XmlAttributeValue && PsiTreeUtil.getParentOfType(
                        ...
                        )?.isEventHandler() == true && !TtmlJSInjector.DOUBLE_BRACE_REGEX.matches(
                                injectionHost.value
                        )) {
                    // 事件
                    // 找到js文件中的methods
