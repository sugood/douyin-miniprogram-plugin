...
import com.sugood.ijplugin.tt_miniprogram.utils.*
...
@Service
class TTMLMetadata(private val project: Project) {
    ...
    companion object {
        ...
        fun getElementDescriptions(project: Project): List<WXMLElementDescription> {
            return project.getService(TTMLMetadata::class.java).elementDescriptors
        }
