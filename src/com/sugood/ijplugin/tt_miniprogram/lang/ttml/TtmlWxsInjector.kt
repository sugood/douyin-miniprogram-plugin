 ...
 * 在wxml中的wxs标签中注入js语言
 */
class TtmlWxsInjector : MultiHostInjector {

    override fun getLanguagesToInject(registrar: MultiHostRegistrar, context: PsiElement) {
        if (context.language is TTMLLanguage && context is XmlTextImpl) {
            val xmlTag = context.parentOfType<XmlTag>()
            val scriptTagName = if (context.project.isQQContext()) "qs" else "sjs"
