...
package com.sugood.ijplugin.tt_miniprogram.lang.ttml.attributes
...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.TTMLLanguage
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.TTMLMetadata
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.WXMLPsiFile
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.tag.WXMLElementDescriptor
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.tag.WxmlCustomComponentDescriptor
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils.WXMLAttributeInsertUtils
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils.WXMLUtils
import com.sugood.ijplugin.tt_miniprogram.qq.QMLFileType
...
class WXMLAttributeNameCompletionProvider : CompletionProvider<CompletionParameters>() {
    ...
    companion object {
         ...
         * 忽略公共的属性的标签名
         */
        val IGNORE_COMMON_ATTRIBUTE_TAG_NAMES = arrayOf("block", "template", "sjs", "import", "include", "slot")

        /**
         * 忽略wx属性的标签名
         */
        val IGNORE_WX_ATTRIBUTE_TAG_NAMES = arrayOf("template", "sjs", "import", "include")

        /**
         * 忽略公共事件的标签名
         */
        val IGNORE_COMMON_EVENT_TAG_NAMES = arrayOf("block", "template", "sjs", "import", "include", "slot")
    }
            ...
            if (descriptor is WxmlCustomComponentDescriptor) {
                ...
                descriptor.wxmlElementDescription.events.filter { event ->
                    xmlAttributes.none { attr ->
                        TTMLLanguage.EVENT_ATTRIBUTE_PREFIX_ARRAY.any {
                            attr == it + event
                        }
                    }
                }.flatMap { event ->
                    TTMLLanguage.EVENT_ATTRIBUTE_PREFIX_ARRAY.map {
                        it + event
                    }
                }.map {
    ...
    private fun addCommonEvents(result: CompletionResultSet, xmlAttributes: Array<String>) {
        result.addAllElements(
                WXMLUtils.generateEventAttributeFullName(TTMLMetadata.COMMON_ELEMENT_EVENTS).filter { event ->
    ...
    private fun addCommonAttribute(
        ...
        result.addAllElements(
                TTMLMetadata.COMMON_ELEMENT_ATTRIBUTE_DESCRIPTORS.filter { attribute -> xmlAttributes.none { it == attribute.key } }
                        .map {
    ...
    private fun addStructureAttribute(
        ...
        result.addAllElements(
                STRUCTURE_ATTRIBUTES.filter { attribute ->
                    xmlAttributes.none {
                        it == "tt:$attribute" || (isQQ && it == "qq:$attribute")
                    }
                }.flatMap {
                    if (isQQ) {
                        listOf("qq:$it", "tt:$it")
