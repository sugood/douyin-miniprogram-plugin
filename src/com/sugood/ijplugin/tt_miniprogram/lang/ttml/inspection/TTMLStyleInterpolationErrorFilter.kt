...
package com.sugood.ijplugin.tt_miniprogram.lang.ttml.inspection
 ...
 */
class TTMLStyleInterpolationErrorFilter : HighlightErrorFilter() {
    override fun shouldHighlightErrorElement(psiErrorElement: PsiErrorElement): Boolean {
        ...
        if (containingFile.language == TTMLLanguage.INSTANCE) {
