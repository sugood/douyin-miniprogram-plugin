 ...
 */
class TTMLElementDescriptorProvider : XmlElementDescriptorProvider {
    override fun getDescriptor(xmlTag: XmlTag): XmlElementDescriptor? {
        if (xmlTag.language !is TTMLLanguage) {
            return null
        }
        ...
        return TTMLMetadata.getElementDescriptions(xmlTag.project).find {
            it.name == tagName
        }?.let {
