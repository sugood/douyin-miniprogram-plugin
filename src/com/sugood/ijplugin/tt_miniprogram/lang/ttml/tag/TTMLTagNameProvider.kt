...
package com.sugood.ijplugin.tt_miniprogram.lang.ttml.tag
...
import com.sugood.ijplugin.tt_miniprogram.utils.AppJsonUtils
import com.sugood.ijplugin.tt_miniprogram.utils.ComponentJsonUtils
import com.sugood.ijplugin.tt_miniprogram.utils.getPathRelativeToRootRemoveExt


class TTMLTagNameProvider : XmlTagNameProvider {
    override fun addTagNameVariants(
            elements: MutableList<LookupElement>, tag: XmlTag, prefix: String
    ) {
        if (tag.language == TTMLLanguage.INSTANCE) {
            // 自带组件
            elements.addAll(TTMLMetadata.getElementDescriptions(tag.project).map {
