...
package com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils
...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.attributes.WXMLAttributeDescriptor
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.attributes.WXMLCustomComponentAttributeDescriptor
...
import com.sugood.ijplugin.tt_miniprogram.utils.ComponentJsUtils
import com.sugood.ijplugin.tt_miniprogram.utils.ComponentWxmlUtils
...
object WXMLUtils {
    ...
    fun likeEventAttribute(attributeName: String): Boolean {
        return TTMLLanguage.EVENT_ATTRIBUTE_PREFIX_ARRAY.any { attributeName.startsWith(it) }
    }
    ...
    fun isCommonAttributes(attributeName: String): Boolean {
        return TTMLMetadata.COMMON_ELEMENT_ATTRIBUTE_DESCRIPTORS.any {
...
fun XmlAttribute.isEventHandler(): Boolean {
    val name = this.name
    return TTMLLanguage.EVENT_ATTRIBUTE_PREFIX_ARRAY.any {
        name.startsWith(it)
    }
}
