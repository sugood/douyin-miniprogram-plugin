...
package com.sugood.ijplugin.tt_miniprogram.lang.ttml.xmlExtension
...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils.isJsTypeAttribute
import com.sugood.ijplugin.tt_miniprogram.qq.QMLFileType

class TtmlXmlExtension : DefaultXmlExtension() {
    ...
    override fun isAvailable(file: PsiFile): Boolean {
        return file.fileType == TTMLFileType.INSTANCE || (file.project.isQQContext() && file.fileType == QMLFileType.INSTANCE)
    }
    ...
    override fun getAttributeValuePresentation(
        ...
        if (tag !== null) {
            val attributeDescription = TTMLMetadata.findElementAttributeDescription(tag, attributeName)
    ...
    override fun getPrefixDeclaration(context: XmlTag, namespacePrefix: String?): SchemaPrefix? {
        if (namespacePrefix != null && (namespacePrefix == "tt"
