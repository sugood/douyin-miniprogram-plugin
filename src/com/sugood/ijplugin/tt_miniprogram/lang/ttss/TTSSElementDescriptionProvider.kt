...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.attributes.WXMLAttributeNameCompletionProvider.Companion.IGNORE_COMMON_ATTRIBUTE_TAG_NAMES
import com.sugood.ijplugin.tt_miniprogram.utils.findChildrenOfType

class TTSSElementDescriptionProvider : CssElementDescriptorProvider() {
    ...
    override fun isPossibleSelector(selector: String, context: PsiElement): Boolean {
        return selector == "page" || TTMLMetadata.getElementDescriptions(context.project).any { it.name == selector }
    }
