...
package com.sugood.ijplugin.tt_miniprogram.navigation
...
import com.sugood.ijplugin.tt_miniprogram.context.RelateFileHolder
import com.sugood.ijplugin.tt_miniprogram.context.isQQContext
import com.sugood.ijplugin.tt_miniprogram.context.isWechatMiniProgramContext
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.TTMLFileType
import com.sugood.ijplugin.tt_miniprogram.lang.ttss.TTSSFileType
import com.sugood.ijplugin.tt_miniprogram.localization.message
import com.sugood.ijplugin.tt_miniprogram.qq.QMLFileType
import com.sugood.ijplugin.tt_miniprogram.qq.QSSFileType

/**
 * 找到一个组件或页面的相关文件
 */
class DouyinMiniProgramGotoRelatedProvider : GotoRelatedProvider() {
    ...
    class MyGotoRelatedItem(
        ...
        companion object {
            fun create(psiFile: PsiFile): MyGotoRelatedItem? = when (psiFile.fileType) {
                ...
                TTMLFileType.INSTANCE, QMLFileType.INSTANCE -> MyGotoRelatedItem(psiFile, "Template", psiFile.name, 2)
                TTSSFileType.INSTANCE, QSSFileType.INSTANCE -> MyGotoRelatedItem(psiFile, "Styles", psiFile.name, 3)
