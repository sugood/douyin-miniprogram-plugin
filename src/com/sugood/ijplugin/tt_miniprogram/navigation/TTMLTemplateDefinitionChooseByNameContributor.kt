...
import com.sugood.ijplugin.tt_miniprogram.lang.ttml.utils.WXMLModuleUtils
import com.sugood.ijplugin.tt_miniprogram.qq.QMLFileType

class TTMLTemplateDefinitionChooseByNameContributor : ChooseByNameContributor {
    ...
    private fun getTemplateDefinition(project: Project): List<XmlAttributeValue> {
        ...
        virtualFiles.addAll(
                FileTypeIndex.getFiles(
                        TTMLFileType.INSTANCE, allScope
                )
        )
