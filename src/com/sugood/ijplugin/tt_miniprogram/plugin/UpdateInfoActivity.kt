...
import com.sugood.ijplugin.tt_miniprogram.localization.notifyMessage
...
class UpdateInfoActivity : StartupActivity.DumbAware {
    ...
    private fun showUpdateOrInstallNotification(
        ...
        val content = """
                ...
                如果此插件对您有帮助，请支持一下
                <br/>
                <a href="https://github.com/sugood/douyin-miniprogram-plugin/releases">发行记录/更新日志</a>
                <br/>
                <a href="https://github.com/sugood/douyin-miniprogram-plugin/wikis">使用文档</a>
                <br/>
            """.trimIndent()
