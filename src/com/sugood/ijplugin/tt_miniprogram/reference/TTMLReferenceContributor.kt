...
package com.sugood.ijplugin.tt_miniprogram.reference
...
import com.sugood.ijplugin.tt_miniprogram.utils.toTextRange

class TTMLReferenceContributor : PsiReferenceContributor() {

    companion object {
        // 描述可以被解析为路径的元素的属性
        private val PATH_ATTRIBUTES = arrayOf(
                PathAttribute("sjs", "src"),
    ...
    override fun registerReferenceProviders(psiReferenceRegistrar: PsiReferenceRegistrar) {
        ...
        psiReferenceRegistrar.registerReferenceProvider(
                XmlPatterns.xmlAttributeValue().withLocalName("id").withLanguage(TTMLLanguage.INSTANCE),
        ...
        // 解析wxml中的class
        psiReferenceRegistrar.registerReferenceProvider(
                XmlPatterns.xmlAttributeValue().withLanguage(TTMLLanguage.INSTANCE)
                        .inFile(
        ...
        psiReferenceRegistrar.registerReferenceProvider(
                XmlPatterns.xmlAttributeValue().withLanguage(TTMLLanguage.INSTANCE).withLocalName("is").withSuperParent(
        ...
        psiReferenceRegistrar.registerReferenceProvider(
                XmlPatterns.xmlAttributeValue().withLanguage(TTMLLanguage.INSTANCE).withLocalName("name")
                        .withSuperParent(
                                2, XmlPatterns.xmlTag().withLocalName("template")
                        ),
                object : PsiReferenceProvider() {
        ...
        // 解析wxml元素的slot属性
        psiReferenceRegistrar.registerReferenceProvider(
                XmlPatterns.xmlAttributeValue().withLanguage(TTMLLanguage.INSTANCE).withLocalName("slot"),
                object : PsiReferenceProvider() {
                    override fun getReferencesByElement(
                            psiElement: PsiElement, p1: ProcessingContext
                    ): Array<PsiReference> {
        ...
        psiReferenceRegistrar.registerReferenceProvider(
                XmlPatterns.xmlAttribute().withLanguage(TTMLLanguage.INSTANCE),
                object : PsiReferenceProvider() {
                    override fun getReferencesByElement(
