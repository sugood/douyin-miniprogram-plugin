...
package com.sugood.ijplugin.tt_miniprogram.utils
...
object ComponentFilesCreator {
    ...
    fun createWechatComponentFiles(
        ...
        val wxmlFile = PsiFileFactory.getInstance(project).createFileFromText(
                fileName + "." + if (project.isQQContext()) QMLFileType.INSTANCE.defaultExtension else TTMLFileType.INSTANCE.defaultExtension,
                TTMLLanguage.INSTANCE, wxmlTemplate
        )
        val wxssFile = PsiFileFactory.getInstance(project).createFileFromText(
                fileName + "." + if (project.isQQContext()) QSSFileType.INSTANCE.defaultExtension else TTSSFileType.INSTANCE.defaultExtension,
